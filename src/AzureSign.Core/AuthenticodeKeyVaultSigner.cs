...
namespace AzureSign.Core
{
    ...
    public class AuthenticodeKeyVaultSigner : IDisposable
    {
        ...
        /// <param name="appendSignature">Appends the signature.</param>
        ...
        public unsafe int SignFile(ReadOnlySpan<char> path, ReadOnlySpan<char> description, ReadOnlySpan<char> descriptionUrl, bool? pageHashing, bool appendSignature, ILogger? logger = null)
        {
